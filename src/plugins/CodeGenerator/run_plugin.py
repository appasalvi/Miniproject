"""
This script is called by the plugin-wrapper, CodeGenerator.js, which passes down the
...
plugin = CodeGenerator(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
