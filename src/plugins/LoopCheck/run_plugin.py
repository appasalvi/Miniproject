"""
This script is called by the plugin-wrapper, LoopCheck.js, which passes down the
...
logger = logging.getLogger('LoopCheck')
...
plugin = LoopCheck(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
